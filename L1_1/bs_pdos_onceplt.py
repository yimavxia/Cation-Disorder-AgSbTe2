...
def read_pdos_dat(filename, num_atoms):
    ...
    for line in lines[1:]:  # Skip the first line
        ...
        if len(parts) == 5:
            ...
            pdos_ag = float(parts[1]) / num_atoms
            pdos_sb = float(parts[2]) / num_atoms
            pdos_te = (float(parts[3]) + float(parts[4])) / num_atoms  # Sum Te1 and Te2
...
ax1.set_xticks([0.00000000, 0.13692550, 0.22523550, 0.37077520, 0.44469310, 0.605213800])
ax1.set_xticklabels([r'$\Gamma$', r'$L$', r'$B$', r'$Z$', r'$\Gamma$', r'$X$'], fontsize=16)
ax1.set_xlim(0, 0.605213800)
ax1.set_ylim(0, 5)
